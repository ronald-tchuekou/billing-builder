...
import {type IssuerSettingsInput, issuerSettingsSchema,} from "@/features/profile/schemas";
            ...
            >
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="space-y-2">
                  ...
                  <Input id="businessName" {...register("businessName")} className={"bg-background"}/>
                </div>
                <div className="space-y-2">
                  <Label htmlFor="siret">SIRET</Label>
                  <Input id="siret" {...register("siret")} className={"bg-background"}/>
                </div>
                <div className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                <Textarea id="businessAddress" rows={2} {...register("businessAddress")} className={"bg-background"}/>
              </div>
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="space-y-2">
                  ...
                  <Input id="bankName" {...register("bankName")} className={"bg-background"}/>
                </div>
                <div className="space-y-2">
                  <Label htmlFor="iban">IBAN</Label>
                  <Input id="iban" {...register("iban")} className={"bg-background"}/>
                </div>
                <div className="space-y-2">
                  <Label htmlFor="bic">BIC / SWIFT</Label>
                  <Input id="bic" {...register("bic")} className={"bg-background"}/>
                </div>
              </div>
              <div className="space-y-2">
                <Label htmlFor="bankAddress">Adresse de la banque</Label>
                <Textarea id="bankAddress" rows={2} {...register("bankAddress")} className={"bg-background"}/>
              </div>
              <div className="space-y-2">
